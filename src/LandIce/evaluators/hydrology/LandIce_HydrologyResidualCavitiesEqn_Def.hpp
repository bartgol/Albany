                              ...
                              const Teuchos::RCP<Albany::Layouts>& dl)
{
  ...
  if (IsStokes) {
    ...
    residual = decltype(residual)(p.get<std::string> ("Cavities Eqn Residual Name"),dl->node_scalar_sideset);
    ...
    residual = decltype(residual)(p.get<std::string> ("Cavities Eqn Residual Name"),dl->node_scalar);
